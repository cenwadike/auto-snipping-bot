...
The Solana Sniping Bot is a software tool designed to automate the buying and selling of tokens on the Solana blockchain.
...
- If you prefer to run this in docker, you can either use:
  1. Use docker engine `docker build -t solana-producer-sniping-bot .  && docker run -p 3000:3000 solana-producer-sniping-bot`
...
- If you see following error in your log file:  
  ...
  - FIX: Go to dex and swap some SOL to USDC/WSOL. For example when you swap sol to wsol.
...
The Solana Sniping Bot is provided as is, for learning purposes.
